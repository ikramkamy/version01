...
<div className="item-contact" id="item-id"><img src="./images/icons_Plan de travail 1.png " className="icon-size"/>{t(`Société Barkatinox,sise route de Larabâa, Ouled Slama, Daïra de Bougara (Wilaya de Blida).label`)}</div>
